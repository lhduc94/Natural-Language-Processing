...
class AccentPredictor:
    ...
    def predictaccents(self, _string):
        ...
        numberp = []
        trace = [[0 for i in range(100)] for j in range(len(words))]
        q = [[0 for i in range(100)] for j in range(len(words))]
...
if __name__ == '__main__':
    ...
    for i in xrange(1,10):
        start = time()
        print ap.predictaccents('phi vu rua tien')
        print time() - start
